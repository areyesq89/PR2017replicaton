...
So we now have summary measures (IC50 and AUC) that indicate the response of each cell line to each drug (though not all combinations were included). However, each study measured these values independently. The goal of this analysis is to _investigate how well these two studies agree with each other_. In other words, do the drug response results in one study *replicate* in the other study? 
...
1. _Pearson's_ correlation coefficient: measures the degree of *linear* association 

2. _Spearman's_ correlation coefficient: measures the agreement of the *rankings* of the values of one variable compared to the other.
